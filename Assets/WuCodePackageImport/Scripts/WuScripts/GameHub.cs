...
public static class GameHub
{
    ...
    private static BuildingManager _buldingManager;
    public static BuildingManager BuildingManager => ObjectReferenceUtility.FindReferenceIfNull(ref _buldingManager);
}
